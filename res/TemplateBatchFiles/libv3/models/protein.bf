...
models.protein.empirical_models = {{"LG",  "Empirical model of protein evolution from Le and Gascuel (2008). Ref: https://doi.org/10.1093/molbev/msn067"},
                                   ...
                                   {"mtMet", "Empirical model of protein evolution for metazoan mitochondrial genomes from Le, Dang, and Le. (2017). Ref: 10.1186/s12862-017-0987-y"},
                                   {"mtVer", "Empirical model of protein evolution for vertebrate mitochondrial genomes from Le, Dang, and Le. (2017). Ref: 10.1186/s12862-017-0987-y"},
                                   ...
                                   {"gcpREV", "Empirical model of protein evolution for green plant chloroplast genomes from  from Cox and Foster (2013). Ref: https://doi.org/10.1016/j.ympev.2013.03.030"},
