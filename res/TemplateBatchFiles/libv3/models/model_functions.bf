...
function model.generic.define_model(model_spec, id, arguments, data_filter, estimator_type) {
    ...
    model.generic.define_model.model = utility.callFunction(model.generic.define_model.model["defineQ"], {
        "0": "model.generic.define_model.model",
    ...
    utility.callFunction(model.generic.define_model.model["frequency-estimator"], {
        "0": "model.generic.define_model.model",
        "1": parameters.quote(id),
        "2": parameters.quote(data_filter)
    ...
    if (Type(model.generic.define_model.model["post-definition"]) == "String") {
        utility.callFunction(model.generic.define_model.model["post-definition"], {
            "0": "model.generic.define_model.model"
        });
    }
