...
if (relative_rates.analysis_type ==  relative_rates.protein_type) {
    relative_rates.model_name  = io.SelectAnOption (models.protein.empirical_models,
    ...
    if (relative_rates.plusF == "Yes"){
        relative_rates.model_generator = models.protein.empirical.plusF_generators[relative_rates.model_name];
        relative_rates.model_name  =  relative_rates.model_name + "+F";
    }
    else {
        relative_prot_rates.model_generator = models.protein.empirical.default_generators[relative_rates.model_name];
    }
}                                                      
else {

    relative_rates.model_name  = io.SelectAnOption (models.DNA.models,
                                                    "Select a nucleotide model:");
    relative_rates.model_generator = models.DNA.generators[relative_rates.model_name];
}
/*******************************************************************************************************************/
...
relative_rates.alignment_wide_MLES = estimators.FitSingleModel_Ext (
                                                          ...
                                                          relative_rates.model_generator,
                                                          None,
                                                          None);
...
relative_rates.site_model = model.generic.DefineModel(relative_rates.model_generator,
...
io.SpoolJSON ({ terms.json.input : {terms.json.file: relative_rates.alignment_info[terms.data.file],
				...
				terms.json.global: {terms.json.model: relative_rates.model_name,
