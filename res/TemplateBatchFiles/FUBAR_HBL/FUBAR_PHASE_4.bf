...
fprintf (intermediateHTML, "[FUBAR PHASE 4] Processing ", samples, " samples from each of the ", _chainCount, " chains on a ", points, "-point grid for a dataset with ", 
                            sites, " sites and ", sequences, " sequences.\n");
