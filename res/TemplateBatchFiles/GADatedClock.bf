...
_mpiPrefixString * ("ExecuteAFile(HYPHY_BASE_DIRECTORY + \"TemplateBatchFiles\" + DIRECTORY_SEPARATOR + \"TreeTools.ibf\");\nExecuteAFile(HYPHY_BASE_DIRECTORY + \"TemplateBatchFiles\" + DIRECTORY_SEPARATOR + \"GADatedClock.ibf\");");
...
for (rateClassesCount = startWithRateClasses; rateClassesCount < maxRateClasses; rateClassesCount = rateClassesCount + 1)
{
	...
	ExecuteAFile (HYPHY_BASE_DIRECTORY + "TemplateBatchFiles" + DIRECTORY_SEPARATOR + "GA_CHC.ibf");
