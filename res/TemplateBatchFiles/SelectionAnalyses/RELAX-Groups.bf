...
console.log (relax.codon_data_info);
...
relax.codon_frequencies_reference     = utility.defineFrequencies ("RELAX.codon_filter.reference");
relax.codon_frequencies_test          = utility.defineFrequencies ("RELAX.codon_filter.test");
