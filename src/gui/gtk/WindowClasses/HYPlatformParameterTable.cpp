...
static GtkItemFactoryEntry hyphy_parameter_table_window_menu[] = {
	...
	{ "/Likelihood/View Options/_Local parameters",			  NULL,    hyphy_menu_item_callback,			    HY_PT_WIN32_MENU_BASE+10, "<CheckItem>" },
	{ "/Likelihood/View Options/_Global parameters",		  NULL,    hyphy_menu_item_callback,			    HY_PT_WIN32_MENU_BASE+11, "<CheckItem>" },
	{ "/Likelihood/View Options/_Constrained parameters",     NULL,    hyphy_menu_item_callback,			    HY_PT_WIN32_MENU_BASE+12, "<CheckItem>" },
	{ "/Likelihood/View Options/_Rate classes",     NULL,    hyphy_menu_item_callback,			    HY_PT_WIN32_MENU_BASE+13, "<CheckItem>" },
	{ "/Likelihood/View Options/_Trees",     NULL,    hyphy_menu_item_callback,			    HY_PT_WIN32_MENU_BASE+14, "<CheckItem>" },
	{ "/Likelihood/sep1",									  NULL,    NULL,           0,	"<Separator>" },
	{ "/Likelihood/_Recalculate LF",     "<control>U",    hyphy_menu_item_callback,			    HY_PT_WIN32_MENU_BASE, "<Item>" },
	{ "/Likelihood/_Optimize LF",     "<control>T",    hyphy_menu_item_callback,			    HY_PT_WIN32_MENU_BASE+1, "<Item>" },
	{ "/Likelihood/sep2",									  NULL,    NULL,           0,	"<Separator>" },
	{ "/Likelihood/_Enter command",     NULL,		hyphy_menu_item_callback,			    HY_PT_WIN32_MENU_BASE+2, "<Item>" },
	{ "/Likelihood/Remove _unused parameters",     NULL,		hyphy_menu_item_callback,			    HY_PT_WIN32_MENU_BASE+3, "<Item>" },
	{ "/Likelihood/sep3",									  NULL,    NULL,           0,	"<Separator>" },
	{ "/Likelihood/Covariance, sampler and C_I",     NULL,		hyphy_menu_item_callback,			    HY_PT_WIN32_MENU_BASE+4, "<Item>" },
	{ "/Likelihood/Likelihood pro_file plot",     NULL,		hyphy_menu_item_callback,			    HY_PT_WIN32_MENU_BASE+5, "<Item>" },
	{ "/Likelihood/sep4",									  NULL,    NULL,           0,	"<Separator>" },
	{ "/Likelihood/Cate_gories Processor",     NULL,		hyphy_menu_item_callback,			    HY_PT_WIN32_MENU_BASE+6, "<Item>" },
	{ "/Likelihood/sep5",									  NULL,    NULL,           0,	"<Separator>" },
	{ "/Likelihood/Sele_ct parameters",     NULL,		hyphy_menu_item_callback,			    HY_PT_WIN32_MENU_BASE+7, "<Item>" },
	{ "/Likelihood/_Open selection in table",     NULL,		hyphy_menu_item_callback,			    HY_PT_WIN32_MENU_BASE+8, "<Item>" }
};
