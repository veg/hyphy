...
{	
	...
	theColors << HYColorToLong (black);
	theColors << HYColorToLong ((_HYColor){210,210,210});
	theColors << HYColorToLong ((_HYColor){255,255,255});
	theColors << HYColorToLong (black);
	theColors << HYColorToLong (black);
	theColors << HYColorToLong ((_HYColor){100,100,100});

	theColors << HYColorToLong ((_HYColor){180,180,180});
	theColors << HYColorToLong ((_HYColor){200,200,200});
	theColors << HYColorToLong ((_HYColor){220,220,220});
	theColors << HYColorToLong (black);
	theColors << HYColorToLong ((_HYColor){60,60,60});
	theColors << HYColorToLong ((_HYColor){255,255,255});
