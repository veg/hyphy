/*
	...
	Sergei L. Kosakovsky Pond, February 2002.
*/
						  ...
						  :_HYTWindow (n,false,true,ptr)
{
	...
	//b2->SetBackColor (bgRGB);
	//l1->SetBackColor (bgRGB);
	l1->SetForeColor ((_HYColor){0,0,0});
		...
		if (e->EventClass()==_hyTextEditChange)
		{
			...
			*sigValue2 = (((_HYTextBox*)components (7))->GetText()).toNum();
			...
			if (good!=lastState)
			{
				...
				((_HYTextBox*)components (0))->SetForeColor ((_HYColor){good?0:127,good?127:0,0});
				((_HYTextBox*)components (7))->SetForeColor ((_HYColor){good?0:127,good?127:0,0});
			}
			...
			if (e->EventClass()==_hyMenuSelChangeEvent)
			{
				...
				if (i==5)
				{
					if (*option != f)
					{
						...
						{
							if (*option < 6)
								l3->SetForeColor((_HYColor){0,0,0});
						...
						else
						{
							...
							l3->SetForeColor((_HYColor){127,127,127});
							l3->_MarkForUpdate();
							tb2->SetForeColor	((_HYColor){255,255,255});						
						}
						...
						if (f<2)
						{
							if ((*option > 2)||(*option < 0))
							{
								...
								l2->SetForeColor((_HYColor){127,127,127});
								l2->_MarkForUpdate();
								tb1->SetForeColor	((_HYColor){255,255,255});
						...
						{
							if (*option < 2)
								l2->SetForeColor((_HYColor){0,0,0});
