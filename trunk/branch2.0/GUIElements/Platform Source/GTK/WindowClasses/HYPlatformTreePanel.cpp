...
GdkColor	navPen = HYColorToGDKColor((_HYColor){255,151,51});
...
static GtkItemFactoryEntry hyphy_tree_window_menu[] = {
	...
	{ "/Edit/Search and Repla_ce",     "<control>F",    hyphy_menu_item_callback,			    HY_WINDOW_MENU_ID_EDIT+6, "<Item>" },
	{ "/Edit/Search and Re_place in Selection",     NULL,    hyphy_menu_item_callback,			HY_WINDOW_MENU_ID_EDIT+7, "<Item>" },
	{ "/_Tree",			NULL,         NULL,           0,					"<Branch>" },
	{ "/Tree/Tip _Labels", NULL, hyphy_menu_item_callback, HY_TREE_GTK_MENU_BASE, "<CheckItem>"},
	{ "/Tree/I_nternal Labels", NULL, hyphy_menu_item_callback, HY_TREE_GTK_MENU_BASE+1, "<CheckItem>"},
	{ "/Tree/sep2",			NULL,         NULL,           0,		"<Separator>" },
	{ "/Tree/S_wap Subtrees",     "<control>1",    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+2, "<Item>" },
	{ "/Tree/_Collapse Branch",     "<control>2",    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+3, "<Item>" },
	{ "/Tree/_Join",     "<control>3",    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+4, "<Item>" },
	{ "/Tree/_Graft A Tip",     "<control>4",    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+5, "<Item>" },
	{ "/Tree/_Reroot",     "<control>5",    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+6, "<Item>" },
	{ "/Tree/_Flip Tip Ordering",     "<control>6",    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+7, "<Item>" },
	{ "/Tree/sep3",			NULL,         NULL,           0,		"<Separator>" },
	{ "/Tree/Select Branches",			NULL,         NULL,           0,					"<Branch>" },
	{ "/Tree/Select Branches/Select _Entire Subtree",     NULL,    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+8, "<Item>" },
	{ "/Tree/Select Branches/Select _Incomplete Branchhes",     "<control>I",    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+9, "<Item>" },
	{ "/Tree/Select Branches/Select Bran_ches Without Models",     NULL,    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+10, "<Item>" },
	{ "/Tree/Select Branches/Select Branches By _Name",     NULL,    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+17, "<Item>" },
	{ "/Tree/Select Branches/Select Branches By _Length",     NULL,    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+18, "<Item>" },
	{ "/Tree/Select Branches/_Invert Selection",     NULL,    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+30, "<Item>" },
	{ "/Tree/Select Branches/_Grow Selection",     NULL,    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+31, "<Item>" },
	{ "/Tree/Select Branches/_Map Selection to Datapanel",     NULL,    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+32, "<Item>" },
	{ "/Tree/Select Branches/_Find selection in another tree",     NULL,    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+33, "<Item>" },
	{ "/Tree/Edit Prope_rties",     NULL,    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+11, "<Item>" },
	{ "/Tree/sep4",			NULL,         NULL,           0,		"<Separator>" },
	{ "/Tree/Optimi_ze Again",     "<control>T",    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+12, "<Item>" },
	{ "/Tree/Sh_ow Parameters in Table",     "<control>H",    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+13, "<Item>" },
	{ "/Tree/sep5",			NULL,         NULL,           0,		"<Separator>" },
	{ "/Tree/Tr_ee Display Options...",     NULL,    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+14, "<Item>" },
	{ "/Tree/Branch Labels",			NULL,         NULL,           0,					"<Branch>" },
	{ "/Tree/Branch Labels/_Above Branches",     "<control>8",    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+24, "<Item>" },
	{ "/Tree/Branch Labels/_Below Branches",     "<control>9",    hyphy_menu_item_callback,			    HY_TREE_GTK_MENU_BASE+25, "<Item>" },
	{ "/Tree/sep6",			NULL,         NULL,           0,		"<Separator>" },
	{ "/Tree/Show Rate Matri_x",			NULL,         hyphy_menu_item_callback,           HY_TREE_GTK_MENU_BASE+15,					"<Item>" },
	{ "/Tree/S_how Transition Matrix",			NULL,         hyphy_menu_item_callback,           HY_TREE_GTK_MENU_BASE+16,					"<Item>" },
	{ "/Tree/sep7",			NULL,         NULL,           0,		"<Separator>" },
	{ "/Tree/Pairwise Distan_ces",			NULL,         hyphy_menu_item_callback,           HY_TREE_GTK_MENU_BASE+19,					"<Item>" },
	{ "/Tree/Branch Length Distributi_on",			NULL,         hyphy_menu_item_callback,           HY_TREE_GTK_MENU_BASE+20,					"<Item>" },
	{ "/Tree/sep8",			NULL,         NULL,           0,		"<Separator>" },
	{ "/Tree/Tree Compar_ison",			NULL,         NULL,           0,					"<Branch>" },
	{ "/Tree/Tree Comparison/Test For _Equality",			NULL,         hyphy_menu_item_callback,           HY_TREE_GTK_MENU_BASE+35,					"<Item>" },
	{ "/Tree/Tree Comparison/Find _Subtree In Another Tree",			NULL,         hyphy_menu_item_callback,           HY_TREE_GTK_MENU_BASE+36,					"<Item>" },
	{ "/Tree/Tree Comparison/Find _Maximal Common Subtree",			NULL,         hyphy_menu_item_callback,           HY_TREE_GTK_MENU_BASE+37,					"<Item>" },
	{ "/Tree/Tree Comparison/Find Maximal Common _Forest",			NULL,         hyphy_menu_item_callback,           HY_TREE_GTK_MENU_BASE+38,					"<Item>" },
	{ "/Tree/Tree Comparison/_Match Tree To Pattern",			NULL,         hyphy_menu_item_callback,           HY_TREE_GTK_MENU_BASE+39,					"<Item>" },
	{ "/Tree/Match Leaves To Se_quence Data",			NULL,         hyphy_menu_item_callback,           HY_TREE_GTK_MENU_BASE+40,					"<Item>" },
		...
		else
		{
			if (theMessage->theEvent->type == GDK_KEY_PRESS)
			{
				...
				if (kp->keyval == GDK_Delete || kp->keyval == GDK_BackSpace)
				{
					...
					if (kp->keyval == GDK_Return || kp->keyval == GDK_KP_Enter)
					{
						InvokeNodeEditor ();
						_UpdateOperationsMenu();
						return true;					
	...
	if (menu_items && !gtk_item_factory_get_widget(menu_items,"<HY_WINDOW>/Edit/Search and Replace"))
	{
		...
		else
		{
			for (long k=0; k<treeProcessors.lLength; k++)
			{
				...
				GtkItemFactoryEntry aProcEntry = {NULL,NULL,hyphy_menu_item_callback,HY_TREE_GTK_MENU_BASE+1000+k,type.sData};
