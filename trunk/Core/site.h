...
//	void	 SetFilter  (_DataSet*, char, _String&); 
	...
	void	 SetMap  (_SimpleList& newMap) 
			{theNodeMap.Clear();theNodeMap.Duplicate(&newMap);} // used to allow nonsequential maps to tree leaves
	...
	char*	 GetColumn (long index) { return ((_Site*)(((BaseRef*)theData->lData)[theData->theMap.lData[theMap.lData[index]]]))->sData;}
