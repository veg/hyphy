...
The latest WebAssembly build can be downloaded from the GitHub releases page. Go to the [GitHub Releases](https://github.com/veg/hyphy/releases) and look for releases named "WebAssembly Build". Download the `hyphy-wasm.tar.gz` file and extract it to get:
